...
struct SchmynthVoiceManager {
    ...
    init() {
        voices = (SchmynthVoice(), SchmynthVoice(), SchmynthVoice(), SchmynthVoice(),
                  SchmynthVoice(), SchmynthVoice(), SchmynthVoice(), SchmynthVoice())
    ...
    private mutating func seedAllTolerances() {
        voices.0.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 0, warm: params.warm)
        voices.1.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 1, warm: params.warm)
        voices.2.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 2, warm: params.warm)
        voices.3.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 3, warm: params.warm)
        voices.4.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 4, warm: params.warm)
        voices.5.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 5, warm: params.warm)
        voices.6.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 6, warm: params.warm)
        voices.7.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 7, warm: params.warm)
    ...
    private func voiceAt(_ i: Int) -> SchmynthVoice {
        switch i {
    ...
    mutating func configure(
        waveform: Int, cutoff: Float, resonance: Float, filterMode: Int,
        ...
        voices.0.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 0, warm: warm)
        voices.1.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 1, warm: warm)
        voices.2.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 2, warm: warm)
        voices.3.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 3, warm: warm)
        voices.4.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 4, warm: warm)
        voices.5.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 5, warm: warm)
        voices.6.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 6, warm: warm)
        voices.7.tolerance = SchmynthVoice.seedTolerance(voiceIndex: 7, warm: warm)
    }
...
extension SchmynthVoiceManager: NoteReceiver {
