...
final class FlowDSPTests: XCTestCase {
    ...
    func testVoiceNoiseDecorrelation() {
        ...
        manager.configureFlow(current: 0.9, viscosity: 0.1, obstacle: 0.5, channel: 0.8, density: 0.8, warmth: 0.3, filter: 0.5, filterMode: 0, width: 0.5, attack: 0.01, decay: 0.3)
    ...
    func testPeakLevelDiagnostic() {
        ...
        for voiceCount in 1...8 {
            var manager = FlowVoiceManager()
            manager.configureFlow(current: 0.5, viscosity: 0.3, obstacle: 0.5, channel: 0.5, density: 0.5, warmth: 0.3, filter: 0.5, filterMode: 0, width: 0.5, attack: 0.01, decay: 0.3)
    ...
    func testRapidRetriggerStress() {
        var manager = FlowVoiceManager()
        manager.configureFlow(current: 0.4, viscosity: 0.4, obstacle: 0.4, channel: 0.5, density: 0.5, warmth: 0.3, filter: 0.5, filterMode: 0, width: 0.5, attack: 0.01, decay: 0.3)
